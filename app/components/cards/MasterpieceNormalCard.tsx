...
export function MasterpieceNormalCard({ id, imageSrc, title, price }: MasterpieceNormalCardProps) {
  ...
  return (
    <div className={`flex flex-col gap-[10px] items-center w-[325px] shrink-0 ${ANIMATION_CLASSES.hoverZoomBase}`}>
      ...
      <div style={{ fontFamily: "'Futura PT', sans-serif" }} className="flex flex-col gap-[10px] items-center text-black w-[240px]">
        <p className="text-[16px] text-center uppercase leading-[96.8%]">{title}</p>
